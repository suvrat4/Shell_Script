...
# Create a new tab for MTTR statistics and status counts chart
wb = Workbook()
ws = wb.active
ws.title = 'MTTR and Status Counts'
...
# Add status counts to the new tab
ws['D1'] = 'Status'
ws['E1'] = 'Count'
...
data = Reference(ws, min_col=5, min_row=1, max_col=5, max_row=len(status_counts))
categories = Reference(ws, min_col=4, min_row=2, max_row=len(status_counts))
